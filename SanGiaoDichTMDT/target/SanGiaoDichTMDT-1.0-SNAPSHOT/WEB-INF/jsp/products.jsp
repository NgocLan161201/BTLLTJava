<%-- 
    Document   : products
    Created on : Aug 27, 2022, 1:48:53 PM
    Author     : trant
--%>
...
<link href="<c:url value='/resources/css/products.css' />" rel="stylesheet"></link>

<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" />
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>

<div class="container bootdey d-flex">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav prod-cat flex-column">
                    <li>
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-angle-right"></i>Dress</a>
                        <ul class="nav dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="fa fa-angle-right"></i> Shirt</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa fa-angle-right"></i> Pant</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa fa-angle-right"></i> Shoes</a></li>
                        </ul>
                    </li>
                    <li>
